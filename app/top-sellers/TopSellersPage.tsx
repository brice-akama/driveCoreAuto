    ...
    export type TopSellersPageProps = {
      categorySlug?: string;
...
const BRANDS = ["Toyota", "Nissan", "Subaru", "Honda", "Mazda","Accessories", "Free Shipping","Scion", "Acure","lexus", "Top Sellers",];
