    ...
    export type SwapsSubaruPageProps = {
      categorySlug?: string;
    ...
    function getDiscountedPrice(price: number, discountPercent?: number) {
      ...
      async function fetchTranslations() {
        try {
          ...
          const toyota = await translate("Subaru Swaps");
    ...
    const slugifyEngineCodeForUrl = (code: string) =>
      ...
      if (engineSlug) params.set("category", engineSlug);   // swapsNissan
    ...
    useEffect(() => {
      ...
      <BrandLinksNav currentBrand=" Subaru Swaps" />
    </div>
