    ...
    export type SwapsNissanPageProps = {
      categorySlug?: string;
    ...
    function getDiscountedPrice(price: number, discountPercent?: number) {
      ...
      async function fetchTranslations() {
        try {
          ...
          const toyota = await translate("Nissan Swaps");
    ...
    useEffect(() => {
      ...
      <BrandLinksNav currentBrand=" Nissan Swaps" />
    </div>
