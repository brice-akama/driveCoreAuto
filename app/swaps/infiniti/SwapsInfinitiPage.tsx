    ...
    export type SwapsInfinitiPageProps = {
      categorySlug?: string;
    ...
    function getDiscountedPrice(price: number, discountPercent?: number) {
      ...
      async function fetchTranslations() {
        try {
          ...
          const toyota = await translate("Infiniti Swaps");
    ...
    useEffect(() => {
      ...
      <BrandLinksNav currentBrand="Infiniti Swaps" />
    </div>
