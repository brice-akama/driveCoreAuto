    ...
    export type TransmissionsLexusAutomaticPageProps = {
      categorySlug?: string;
    ...
    export default function TransmissionsLexusAutomaticPage({
    ...
    }: TransmissionsLexusAutomaticPageProps) {
      ...
      const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("transmissionsLexusAutomatic", "true");
    ...
    useEffect(() => {
      ...
      <BrandLinksNav currentBrand="Transmissions Lexux Automatic" />
    </div>
