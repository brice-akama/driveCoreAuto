...
export default function TransmissionsLexusAutomaticPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("transmissionsLexusAutomatic", "true");  // keep this always
        ...
        router.push(`/transmissions/lexus/automatic?${params.toString()}`);  // transmissionsHondataAutomatic
    ...
    const [translatedTexts, setTranslatedTexts] = useState({
        ...
        home: " Home",
        subaruAutomatic: "Lexus Transmissions Automatic",
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const subaruAutomatic = await translate("Lexus Transmissions Automatic");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    subaruAutomatic: subaruAutomatic || "Lexus Transmissions Automatic",
    ...
    useEffect(() => {
        (async () => {     //
            ...
            try {
                const res = await fetch("/api/products?transmissionsLexusAutomatic=true");
                ...
                productList.forEach((p) => {
                    ...
                    const match = name.match(/Lexus\s+(\w+)/i);
                    if (match && match[1]) {
    ...
    useEffect(() => {
        (async () => {
            setLoading(true);
            let apiUrl = "/api/products?transmissionsLexusAutomatic=true";
    ...
    const extractModel = (name: string): string => {
        const match = name.match(/Lexus\s+\w+/i);
        return match ? match[0].toUpperCase() : "LEXUS ENGINE";
    };
    ...
    const selectEngineCode = (code: string) => {
        ...
        router.push(`/transmissions/lexus/automatic?category=${slug}`);
    ...
    return (
        ...
        <>
            <div className=" md:mt-0">
                ...
                <BrandLinksNav currentBrand="Lexus Transmissions Automatic" />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-10 ">
                ...
                >
                    ...
                    <ol className="inline-flex items-center space-x-2">
                        ...
                        <li>/</li>
                        <li className="text-gray-900 font-medium">{translatedTexts.subaruAutomatic}</li>
                                    ...
                                    >
                                        ...
                                        <div className="p-4 text-center">
                                            ...
                                            <button
                                                ...
                                                className="mt-3 w-full border border-gray-700 rounded py-2 hover:bg-gray-700 hover:text-white transition text-white bg-blue-800"
                                            >
