    ...
    export type TransmissionsPageProps = {
      categorySlug?: string;
    ...
    export default function TransmissionsPage({
      ...
      const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        router.push(`transmissions?${params.toString()}`);
      };
    ...
    function getDiscountedPrice(price: number, discountPercent?: number) {
      ...
      async function fetchTranslations() {
        try {
          ...
          const toyota = await translate("transmissions");
...
const BRANDS = ["Toyota", "Nissan", "Subaru", "Honda", "Mazda","Accessories", "Free Shipping","Scion", "Acure","lexus",];
...
const extractModel = (name: string): string => {
  ...
  return fallback.toUpperCase() || "UNKNOWN ENGINE";
    ...
    useEffect(() => {
      ...
      <BrandLinksNav currentBrand="transmissions" />
    </div>
