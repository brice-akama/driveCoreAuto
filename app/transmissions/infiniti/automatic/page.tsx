...
export default function TransmissionsSubaruAutomaticPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("transmissionsInfinitAutomatic", "true");  // keep this always
        ...
        router.push(`/transmissions/infiniti/automatic?${params.toString()}`);  // transmissionsHondataAutomatic
    ...
    const [translatedTexts, setTranslatedTexts] = useState({
        ...
        home: " Home",
        subaruAutomatic: "Infiniti Transmissions Automatic",
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const subaruAutomatic = await translate("Infiniti Transmissions Automatic");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    subaruAutomatic: subaruAutomatic || "Infiniti Transmissions Automatic",
    ...
    useEffect(() => {
        (async () => {     //
            ...
            try {
                const res = await fetch("/api/products?transmissionsInfinitAutomatic=true");
    ...
    // Fetch filtered products when applied filters change   // infiniti
    useEffect(() => {
        (async () => {
            setLoading(true);
            let apiUrl = "/api/products?transmissionsInfinitAutomatic=true";
    ...
    const selectEngineCode = (code: string) => {
        ...
        router.push(`/transmissions/infiniti/automatic?category=${slug}`);
    ...
    return (
        ...
        <>
            <div className=" md:mt-0">
                ...
                <BrandLinksNav currentBrand="Infiniti Transmissions Automatic" />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-10 ">
                ...
                <div className="flex gap-6">
                    ...
                    <aside className="hidden sm:flex flex-col w-56 shrink-0 gap-6 relative mt-5">
                        ...
                        {/* Engine Code Input */}
                        <div>
                            <label htmlFor="engineCodeInput" className="block font-bold mt-4">
                                {translatedTexts.engineCodes}
                            </label>
                            <input
                                id="engineCodeInput"
