...
export default function TransmissionsInfinitiAutomaticPage() {
  ...
  router.push(`/transmissions/infiniti/automatic?${params.toString()}`);
};
 ...
 const productsPerPage = isMobile ? 6 : 12;
  ...
  const [translatedTexts, setTranslatedTexts] = useState({
    ...
    addToWishList: "Add to Wishlist",
      home: " Home",
      toyota: "Transmissions Infiniti Automatic",
  ...
  async function fetchTranslations() {
    try {
      ...
      const toyota = await translate("Transmissions Infiniti Automatic");
      ...
      setTranslatedTexts({
        ...
        home: home || "Home",
        toyota: toyota || "Transmissions Infiniti Automatic",
    ...
    (async () => {
      try {
        ...
        productList.forEach((p) => {
          ...
          const match = name.match(/Transmissions Infiniti Automatic\s+(\w+)/i);
          if (match && match[1]) {
...
useEffect(() => {
  ...
  <BrandLinksNav currentBrand="Transmissions Infiniti Automatic" />
</div>
