...
export default function TransmissionsToyotaAutomaticPage() {
...
const [hoveredIcon, setHoveredIcon] = useState<string | null>(null);
  ...
  params.set("transmissionsToyotaAutomatic", "true");  // keep this always
  ...
  router.push(`/transmissions/toyota/automatic?${params.toString()}`);
 ...
 const productsPerPage = isMobile ? 6 : 12;
  ...
  const [translatedTexts, setTranslatedTexts] = useState({
    ...
    addToWishList: "Add to Wishlist",
      home: " Home",
      toyotaAutomatic: "Toyota Transmissions Automatic",
  ...
  async function fetchTranslations() {
    try {
      ...
      const toyotaAutomatic = await translate("Toyota Transmissions Automatic");
      ...
      setTranslatedTexts({
        ...
        home: home || "Home",
        toyotaAutomatic: toyotaAutomatic || "Toyota Transmissions Automatic",
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await fetch("/api/products?transmissionsToyotaAutomatic=true");
  ...
  useEffect(() => {
    (async () => {
      setLoading(true);
    let apiUrl = "/api/products?transmissionsToyotaAutomatic=true";
...
router.push(`/transmissions/toyota/automatic?category=${slug}`);
...
useEffect(() => {
  ...
  <BrandLinksNav currentBrand="Toyota Transmissions Automatic" />
</div>
...
>
        ...
        <ol className="inline-flex items-center space-x-2">
          ...
          <li>/</li>
          <li className="text-gray-900 font-medium">{translatedTexts.toyotaAutomatic}</li>
                ...
                >
                  <Link href={`/products/${product.slug[currentLang] || product.slug.en}`}>
                    <div className="relative w-full h-48 bg-white">
                      <div className="absolute top-2 left-0 bg-blue-800 text-xs font-semibold text-white px-2 py-3 rounded shadow z-10">
