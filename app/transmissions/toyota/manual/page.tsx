...
const [hoveredIcon, setHoveredIcon] = useState<string | null>(null);
  ...
  params.set("transmissionsToyotaManual", "true");  // keep this always
 ...
 const productsPerPage = isMobile ? 6 : 12;
  ...
  const [translatedTexts, setTranslatedTexts] = useState({
    ...
    addToWishList: "Add to Wishlist",
      home: " Home",
      toyotaManual: "Toyota Transmissions Manual",
  ...
  async function fetchTranslations() {
    try {
      ...
      const toyotaManual = await translate("Toyota Transmissions Manual");
      ...
      setTranslatedTexts({
        ...
        home: home || "Home",
        toyotaManual: toyotaManual || "Toyota Transmissions Manual",
...
router.push(`/transmissions/toyota/manuel?category=${slug}`);
...
useEffect(() => {
  ...
  <BrandLinksNav currentBrand="Toyota Transmissions Manuel" />
</div>
...
>
        ...
        <ol className="inline-flex items-center space-x-2">
          ...
          <li>/</li>
          <li className="text-gray-900 font-medium">{translatedTexts.toyotaManual}</li>
