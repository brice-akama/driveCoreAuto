 ...
 const productsPerPage = isMobile ? 6 : 12;
  ...
  const [translatedTexts, setTranslatedTexts] = useState({
    ...
    addToWishList: "Add to Wishlist",
      home: " Home",
      toyota: "Transmissions Toyota Automatic",
  ...
  async function fetchTranslations() {
    try {
      ...
      const toyota = await translate("Transmissions Toyota Automatic");
      ...
      setTranslatedTexts({
        ...
        home: home || "Home",
        toyota: toyota || "Transmissions Toyota Automatic",
    ...
    (async () => {
      try {
        ...
        productList.forEach((p) => {
          ...
          const match = name.match(/Transmissions Toyota Automatic\s+(\w+)/i);
          if (match && match[1]) {
...
useEffect(() => {
  ...
  <BrandLinksNav currentBrand="Transmissions Toyota Automatic" />
</div>
