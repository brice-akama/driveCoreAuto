...
export default function TransmissionsSubaruAutomaticPage() {
  ...
  router.push(`/transmissions/subaru/automatic?${params.toString()}`);
};
 ...
 const productsPerPage = isMobile ? 6 : 12;
  ...
  const [translatedTexts, setTranslatedTexts] = useState({
    ...
    addToWishList: "Add to Wishlist",
      home: " Home",
      toyota: "Transmissions Subaru Automatic",
  ...
  async function fetchTranslations() {
    try {
      ...
      const toyota = await translate("Transmissions Subaru Automatic");
      ...
      setTranslatedTexts({
        ...
        home: home || "Home",
        toyota: toyota || "Transmissions Subaru Automatic",
    ...
    (async () => {
      try {
        ...
        productList.forEach((p) => {
          ...
          const match = name.match(/Transmissions Subaru Automatic\s+(\w+)/i);
          if (match && match[1]) {
...
useEffect(() => {
  ...
  <BrandLinksNav currentBrand="Transmissions Subaru Automatic" />
</div>
