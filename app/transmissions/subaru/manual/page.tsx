...
export default function TransmissionsSubaruManualPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("transmissionsSaburaManuel", "true");  // keep this always
        ...
        router.push(`/transmissions/subaru/manual?${params.toString()}`);  // transmissionsHondataAutomatic
    ...
    const [translatedTexts, setTranslatedTexts] = useState({
        ...
        home: " Home",
        subaruManual: "Subaru Transmissions Manual",
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const subaruManual = await translate("Subaru Transmissions Manual");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    subaruManual: subaruManual || "Subaru Transmissions Manual",
    ...
    useEffect(() => {
        (async () => {     //
            ...
            try {
                const res = await fetch("/api/products?transmissionsSaburaManuel=true");
    ...
    useEffect(() => {
        (async () => {
            setLoading(true);
            let apiUrl = "/api/products?transmissionsSaburaManuel=true";
    ...
    const selectEngineCode = (code: string) => {
        ...
        router.push(`/transmissions/subaru/manual?category=${slug}`);
    ...
    return (
        ...
        <>
            <div className=" md:mt-0">
                ...
                <BrandLinksNav currentBrand="Subaru Transmissions Manual" />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-10 ">
                ...
                >
                    ...
                    <ol className="inline-flex items-center space-x-2">
                        ...
                        <li>/</li>
                        <li className="text-gray-900 font-medium">{translatedTexts.subaruManual}</li>
