...
export default function TransmissionsHondaAutomaticPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("transmissionsHondataAutomatic", "true");  // keep this always
        ...
        router.push(`/transmissions/honda/automatic?${params.toString()}`);  // transmissionsHondataAutomatic
    ...
    const [translatedTexts, setTranslatedTexts] = useState({
        ...
        home: " Home",
        hondataAutomatic: "Honda Transmissions Automatic",
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const hondataAutomatic = await translate("Honda Transmissions Automatic");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    hondataAutomatic: hondataAutomatic || "Honda Transmissions Automatic",
    ...
    useEffect(() => {
        (async () => {     //
            ...
            try {
                const res = await fetch("/api/products?transmissionsHondataAutomatic=true");
    ...
    useEffect(() => {
        (async () => {
            setLoading(true);
            let apiUrl = "/api/products?transmissionsHondataAutomatic=true";
    ...
    const selectEngineCode = (code: string) => {
        ...
        router.push(`/transmissions/honda/automatic?category=${slug}`);
    ...
    return (
        ...
        <>
            <div className=" md:mt-0">
                ...
                <BrandLinksNav currentBrand="Honda Transmissions Automatic" />
            </div>
