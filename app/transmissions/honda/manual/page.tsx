...
export default function TransmissionsHondamanualPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("transmissionsHondaaManuel", "true");  // keep this always
    ...
    const [translatedTexts, setTranslatedTexts] = useState({
        ...
        home: " Home",
        hondaManual: "Honda Transmissions Manual",
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const hondaManual = await translate("Honda Transmissions Manual");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    hondaManual: hondaManual || "Honda Transmissions Manual",
    ...
    useEffect(() => {
        (async () => {     //
            ...
            try {
                const res = await fetch("/api/products?transmissionsHondaaManuel=true");
    ...
    useEffect(() => {
        (async () => {
            setLoading(true);
            let apiUrl = "/api/products?transmissionsHondaaManuel=true";
    ...
    const selectEngineCode = (code: string) => {
        ...
        router.push(`/transmissions/honda/manual?category=${slug}`);
    ...
    return (
        ...
        <>
            <div className=" md:mt-0">
                ...
                <BrandLinksNav currentBrand="Honda Transmissions Manual" />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-10 ">
                ...
                >
                    ...
                    <ol className="inline-flex items-center space-x-2">
                        ...
                        <li>/</li>
                        <li className="text-gray-900 font-medium">{translatedTexts.hondaManual}</li>
