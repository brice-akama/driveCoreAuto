...
export default function TransmissionsAcuraManualPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("transmissionsAcureaManuel", "true");  // keep this always
        ...
        router.push(`/transmissions/acura/manual?${params.toString()}`);  // transmissionsHondataAutomatic
    ...
    const [translatedTexts, setTranslatedTexts] = useState({
        ...
        home: " Home",
        hondataAutomatic: "Acura Transmissions Manual",
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const hondataAutomatic = await translate("Acura Transmissions Manual");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    hondataAutomatic: hondataAutomatic || "Acura Transmissions Manual",
    ...
    useEffect(() => {
        (async () => {     //
            ...
            try {
                const res = await fetch("/api/products?transmissionsAcureaManuel=true");
    ...
    useEffect(() => {
        (async () => {
            setLoading(true);
            let apiUrl = "/api/products?transmissionsAcureaManuel=true";
    ...
    const selectEngineCode = (code: string) => {
        ...
        router.push(`/transmissions/acura/manual?category=${slug}`);
    ...
    return (
        ...
        <>
            <div className=" md:mt-0">
                ...
                <BrandLinksNav currentBrand="Acura Transmissions Manual" />
            </div>
