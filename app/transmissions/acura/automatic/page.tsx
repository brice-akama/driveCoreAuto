...
export default function TransmissionsAcuraAutomaticPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("transmissionsAcuretaAutomatic", "true");  // keep this always
        ...
        router.push(`/transmissions/acura/automatic?${params.toString()}`);  // transmissionsHondataAutomatic
    ...
    const [translatedTexts, setTranslatedTexts] = useState({
        ...
        home: " Home",
        hondataAutomatic: "Acura Transmissions Automatic",
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const hondataAutomatic = await translate("Acura Transmissions Automatic");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    hondataAutomatic: hondataAutomatic || "Acura Transmissions Automatic",
    ...
    useEffect(() => {
        (async () => {     //
            ...
            try {
                const res = await fetch("/api/products?transmissionsAcuretaAutomatic=true");
                ...
                productList.forEach((p) => {
                    ...
                    const match = name.match(/Acura\s+(\w+)/i);
                    if (match && match[1]) {
    ...
    useEffect(() => {
        (async () => {
            setLoading(true);
            let apiUrl = "/api/products?transmissionsAcuretaAutomatic=true";
    ...
    const extractModel = (name: string): string => {
        const match = name.match(/Acura\s+\w+/i);
        return match ? match[0].toUpperCase() : "ACURA ENGINE";
    };
    ...
    const selectEngineCode = (code: string) => {
        ...
        router.push(`/transmissions/acura/automatic?category=${slug}`);
    ...
    return (
        ...
        <>
            <div className=" md:mt-0">
                ...
                <BrandLinksNav currentBrand="Acura Transmissions Automatic" />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-10 ">
                ...
                >
                    ...
                    <ol className="inline-flex items-center space-x-2">
                        ...
                        <li>/</li>
                        <li className="text-gray-900 font-medium">{translatedTexts.hondataAutomatic}</li>
                ...
                <div className="flex gap-6">
                    ...
                    <aside className="hidden sm:flex flex-col w-56 shrink-0 gap-6 relative mt-5">
                        ...
                        {/* Engine Code Input */}
                        <div>
                            <label htmlFor="engineCodeInput" className="block font-bold mt-5">
                                {translatedTexts.engineCodes}
                            </label>
                            <input
                                id="engineCodeInput"
