...
export default function TransmissionsSubaruManualPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("transmissionScionburaManuel", "true");  // keep this always
        ...
        router.push(`/transmissions/scion/manual?${params.toString()}`);  // transmissionsHondataAutomatic
    ...
    const [translatedTexts, setTranslatedTexts] = useState({
        ...
        home: " Home",
        subaruManual: "Scion Transmissions Manual",
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const subaruManual = await translate("Scion Transmissions Manual");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    subaruManual: subaruManual || "Scion Transmissions Manual",
    ...
    useEffect(() => {
        (async () => {     //
            ...
            try {
                const res = await fetch("/api/products?transmissionScionburaManuel=true");
    ...
    useEffect(() => {
        (async () => {
            setLoading(true);
            let apiUrl = "/api/products?transmissionScionburaManuel=true";
    ...
    const selectEngineCode = (code: string) => {
        ...
        router.push(`/transmissions/scion/manual?category=${slug}`);
    ...
    return (
        ...
        <>
            <div className=" md:mt-0">
                ...
                <BrandLinksNav currentBrand="Scion Transmissions Manual" />
            </div>
