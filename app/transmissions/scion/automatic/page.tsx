...
export default function TransmissionsSubaruAutomaticPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("transmissionsScionAutomatic", "true");  // keep this always
        ...
        router.push(`/transmissions/scion/automatic?${params.toString()}`);  // transmissionsHondataAutomatic
    ...
    const [translatedTexts, setTranslatedTexts] = useState({
        ...
        home: " Home",
        subaruAutomatic: "Scion Transmissions Automatic",
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const subaruAutomatic = await translate("Scion Transmissions Automatic");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    subaruAutomatic: subaruAutomatic || "Scion Transmissions Automatic",
    ...
    useEffect(() => {
        (async () => {     //
            ...
            try {
                const res = await fetch("/api/products?transmissionsScionAutomatic=true");
    ...
    useEffect(() => {
        (async () => {
            setLoading(true);
            let apiUrl = "/api/products?transmissionsScionAutomatic=true";
    ...
    const selectEngineCode = (code: string) => {
        ...
        router.push(`/transmissions/scion/automatic?category=${slug}`);
    ...
    return (
        ...
        <>
            <div className=" md:mt-0">
                ...
                <BrandLinksNav currentBrand="Scion Transmissions Automatic" />
            </div>
