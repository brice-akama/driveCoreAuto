...
export default function TransmissionsScionAutomaticPage() {
  ...
  router.push(`/transmissions/scion/automatic?${params.toString()}`);
};
 ...
 const productsPerPage = isMobile ? 6 : 12;
  ...
  const [translatedTexts, setTranslatedTexts] = useState({
    ...
    addToWishList: "Add to Wishlist",
      home: " Home",
      toyota: "Transmissions Scion Automatic",
  ...
  async function fetchTranslations() {
    try {
      ...
      const toyota = await translate("Transmissions Scion Automatic");
      ...
      setTranslatedTexts({
        ...
        home: home || "Home",
        toyota: toyota || "Transmissions Scion Automatic",
    ...
    (async () => {
      try {
        ...
        productList.forEach((p) => {
          ...
          const match = name.match(/Transmissions Scion Automatic\s+(\w+)/i);
          if (match && match[1]) {
...
useEffect(() => {
  ...
  <BrandLinksNav currentBrand="Transmissions Scion Automatic" />
</div>
