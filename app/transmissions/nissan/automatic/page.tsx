...
export default function TransmissionsNissanAutomaticPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("transmissionsNissanAutomatic", "true");  // keep this always
        ...
        router.push(`/transmissions/nissan/automatic?${params.toString()}`);  // transmissionsNissanAutomatic
    ...
    const [translatedTexts, setTranslatedTexts] = useState({
        ...
        home: " Home",
        nissanAutomatic: "Nissan Transmissions Automatic",
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const nissanAutomatic = await translate("Nissan Transmissions Automatic");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    nissanAutomatic: nissanAutomatic || "Nissan Transmissions Automatic",
    ...
    useEffect(() => {
        (async () => {     //
            ...
            try {
                const res = await fetch("/api/products?transmissionsNissanAutomatic=true");
    ...
    useEffect(() => {
        (async () => {
            setLoading(true);
            let apiUrl = "/api/products?transmissionsNissanAutomatic=true";
    ...
    const selectEngineCode = (code: string) => {
        ...
        router.push(`/transmissions/nissan/automatic?category=${slug}`);
    ...
    return (
        ...
        <>
            <div className=" md:mt-0">
                ...
                <BrandLinksNav currentBrand="Nissan Transmissions Automatic" />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-10 ">
                ...
                >
                    ...
                    <ol className="inline-flex items-center space-x-2">
                        ...
                        <li>/</li>
                        <li className="text-gray-900 font-medium">{translatedTexts.nissanAutomatic}</li>
