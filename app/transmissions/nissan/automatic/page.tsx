...
export default function TransmissionsNissanAutomaticPage() {
  ...
  router.push(`/transmissions/nissan/automatic?${params.toString()}`);
};
 ...
 const productsPerPage = isMobile ? 6 : 12;
  ...
  const [translatedTexts, setTranslatedTexts] = useState({
    ...
    addToWishList: "Add to Wishlist",
      home: " Home",
      toyota: "Transmissions Nissan Automatic",
  ...
  async function fetchTranslations() {
    try {
      ...
      const toyota = await translate("Transmissions Nissan Automatic");
      ...
      setTranslatedTexts({
        ...
        home: home || "Home",
        toyota: toyota || "Transmissions Nissan Automatic",
...
useEffect(() => {
  ...
  <BrandLinksNav currentBrand="Transmissions Nissan Automatic" />
</div>
