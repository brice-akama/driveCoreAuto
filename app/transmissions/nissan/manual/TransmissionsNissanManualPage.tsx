...
export type TransmissionsNissanManualPageProps = {
  categorySlug?: string;
...
export default function TransmissionsNissanManualPage({
...
}: TransmissionsNissanManualPageProps) {
  ...
  const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
    ...
    params.set("transmissionNissanburaManuel", "true");
  ...
  async function fetchTranslations() {
    try {
      ...
      setTranslatedTexts({
        ...
        home: home || "Home",
        toyota: toyota || "Transmissions Nissan Manul",
