...
export default function TransmissionsNissanManualPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        router.push(`/transmissions/nissan/manual?${params.toString()}`);  // transmissionsNissanAutomatic
    ...
    const [translatedTexts, setTranslatedTexts] = useState({
        ...
        home: " Home",
        nissanManual: "Nissan Transmissions Manual",
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const nissanManual = await translate("Nissan Transmissions Manual");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    nissanManual: nissanManual || "Nissan Transmissions Manual",
            ...
            <div className="max-w-7xl mx-auto px-4 py-10 ">
                ...
                >
                    ...
                    <ol className="inline-flex items-center space-x-2">
                        ...
                        <li>/</li>
                        <li className="text-gray-900 font-medium">{translatedTexts.nissanManual}</li>
