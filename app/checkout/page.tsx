  ...
  <div className="flex space-x-2 mt-3">
    ...
    >
      Apply Coupon
          ...
          {/* Free shipping bar */}
          <div>
            <span className="font-medium text-gray-800">Your order qualifies for free shipping!</span>
            <div className="w-full bg-red-200 rounded-full mt-1 h-2">
              <div className="bg-blue-500 h-2 rounded-full transition-all" style={{ width: "100%" }} />
            </div>
          </div>
          {/* Billing Details */}
          <div className="w-full space-y-3 lg:col-span-3">
