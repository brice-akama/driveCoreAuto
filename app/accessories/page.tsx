...
export default function TransmissionsSubaruManualPage() {
    ...
    const updateUrl = (vehicleModel?: string | null, engineCode?: string | null) => {
        ...
        params.set("accessories", "true");  // keep this always
        ...
        router.push(`/accessories?${params.toString()}`);  // transmissionsHondataAutomatic
    ...
    useEffect(() => {
        async function fetchTranslations() {
            try {
                ...
                const subaruManual = await translate("Accessories");
                ...
                setTranslatedTexts({
                    ...
                    home: home || "Home",
                    subaruManual: subaruManual || "Accessories",
    ...
    useEffect(() => {
        (async () => {     //
            ...
            try {
                const res = await fetch("/api/products?accessories=true");
    ...
    useEffect(() => {
        (async () => {
            setLoading(true);
            let apiUrl = "/api/products?accessories=true";
    ...
    const selectEngineCode = (code: string) => {
        ...
        router.push(`/accessories?category=${slug}`);
    ...
    return (
        ...
        <>
            <div className=" md:mt-0">
                ...
                <BrandLinksNav currentBrand="Accessories" />
            </div>
